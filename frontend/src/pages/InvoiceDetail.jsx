...
const InvoiceDetail = () => {
  ...
  const refreshInvoice = React.useCallback(async () => {
    ...
    try {
      ...
      console.warn('Failed to refresh invoice:', err?.message || err);
    }
  }, [invoiceId]);
  ...
  const pdfFileName = React.useMemo(() => {
    const number = activeInvoice?.invoice_no || activeInvoice?.invoiceNo || 'draft';
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center px-4">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 px-8 py-10 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-800">
              {isEditMode ? 'جارٍ تحميل بيانات الفاتورة' : 'جارٍ تحميل النموذج'}
            </h2>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4 rtl:space-x-reverse">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    {isEditMode
                      ? 'قم بتعديل تفاصيل الفاتورة وإدارة المدفوعات.'
                      : 'قم بإدخال تفاصيل الفاتورة الجديدة وإضافة البنود.'}
                  </p>
                </div>
              </div>
              ...
              {isEditMode && activeInvoice && (
                <div className="flex items-center gap-3">
                  <button
                    onClick={handlePrint}
                    className="flex items-center gap-2 px-5 py-3 bg-white hover:bg-gray-50 text-gray-700 border-2 border-gray-300 hover:border-gray-400 rounded-xl font-semibold transition-all duration-200 shadow-sm hover:shadow-md"
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white rounded-xl font-semibold transition-all duration-200 shadow-md hover:shadow-lg"
                    disabled={printing || downloading}
                  >
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {isEditMode ? 'المبلغ الإجمالي المستحق.' : 'إجمالي قيمة البنود المضافة.'}
                  </p>
                </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {isEditMode ? `تم دفع ${formatCurrency(paidAmount)} من الإجمالي.` : 'المبلغ المتبقي للدفع.'}
                  </p>
                </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {isEditMode ? 'الحالة الحالية للفاتورة.' : 'ستتغير الحالة حسب المدفوعات.'}
                  </p>
                </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-8 py-6">
              <h2 className="text-xl font-bold text-white">
                {isEditMode ? 'تفاصيل الفاتورة' : 'إضافة فاتورة جديدة'}
              </h2>
              <p className="text-blue-100 mt-1">
                قم بإدخال تفاصيل الفاتورة بدقة. يمكنك إضافة عدة بنود وحساب الإجمالي تلقائياً.
              </p>
            </div>
              ...
              <div className="flex items-start space-x-3 rtl:space-x-reverse">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">
                    يمكنك إضافة عدة بنود للفاتورة والنظام سيحسب الإجمالي تلقائياً.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3 rtl:space-x-reverse">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-700">تتبع المدفوعات الجزئية</p>
                  <p className="text-xs text-gray-600">
                    قم بإضافة المدفوعات الجزئية وتتبع المبلغ المتبقي بسهولة.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3 rtl:space-x-reverse">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">
                    يمكنك ربط الفاتورة مع أمر بيع لاستيراد البنود تلقائياً.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3 rtl:space-x-reverse">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">
                    يمكنك طباعة الفاتورة أو تصديرها بصيغة PDF لإرسالها للعميل.
                  </p>
                </div>
              </div>
            </div>
